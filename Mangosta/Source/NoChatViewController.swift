...
public class NoChatViewController: UIViewController {
...
extension NoChatViewController { // Rotation
...
extension NoChatViewController: UIScrollViewDelegate { // Handler tap status bar
